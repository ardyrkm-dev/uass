        ...
        <div class="flex justify-between items-start">
            <div class="flex">
                <div class="img-profil">
                    <img src="<?php echo e(asset('assets/lelah.svg')); ?>" class="object-cover" alt="">
                </div>
                <div class="ml-4">
        ...
        <div class="flex">
            <div class="card-riwayat">
                <div class="rounded-l overflow-hidden img-cr">
                    <img src="<?php echo e(asset('assets/lelah.svg')); ?>" alt="" class="w-full h-full object-cover" srcset="">
                </div>
                <div class="s-text">
...
<?php echo $__env->make('layouts.guest', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Blender\Final\p\laravel\resources\views\pages\landing\profil.blade.php ENDPATH**/ ?>