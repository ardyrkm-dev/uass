...
@section('content')
  ...
  <form class="col-lg-8" method="POST" action="/dashboard/profile/{{ $userData->id }}">
    ...
    <div class="mb-3">
      ...
      <input type="text" class="form-control formcss @error('name') is-invalid @enderror" id="name" name="name" value="{{ old('name', $userData->name) }}" required>
    ...
    <div class="mb-3">
      ...
      <input type="text" class="form-control formcss @error('username') is-invalid @enderror" id="username" name="username" value="{{ old('username', $userData->username) }}" required>
    ...
    <div class="mb-3">
      ...
      <input type="email" class="form-control formcss @error('email') is-invalid @enderror" id="email" name="email" value="{{ old('email', $userData->email) }}" required>
      ...
      <div class="modal-content">
        ...
        <form action="/dashboard/profile/{{ $userData->id }}" method="POST">
          ...
          <div class="modal-footer">
            ...
            <button type="submit" class="btn btnBaru">Update</button>
          </div>
        </form>
      </div>
    </div>
